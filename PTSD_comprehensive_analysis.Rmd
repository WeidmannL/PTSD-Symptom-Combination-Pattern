---
title: "PTSD comprehensive analysis"
author:
...
# datatable(readable_summary_PTSD_Diagnosis_best_six_symptoms_overall_min_false,
#           options = list(scrollX = TRUE))
```
...
##### 5.5.3.1. Variant 1: Find three best 6-symptom-combinations, with at least one symptom from each cluster by analyzing individual importance, selecting top candidates and testing different combinations

```{r Variant 1: Find three best 6-symptom-combinations, with at least one symptom from each cluster, echo=FALSE, message=FALSE}
### Function to determine the three best 6-symptom-combinations, with at least one symptom from each cluster by analyzing individual importance, selecting top candidates and testing different combinations
  # Depending on the score_by select the best 6-symptom-combinations by minimizing the newly_nondiagnosed or by minimizing the false_cases
  # Input: data set with all patients and 20 columns with non-binarized symptoms
...
variant1_analyze_best_six_symptoms_by_cluster <- function(data, score_by = "false_cases") {
  # Validate scoring method
  valid_scoring <- c("false_cases", "newly_nondiagnosed")
  if (!score_by %in% valid_scoring) {
    stop("score_by must be one of: ", paste(valid_scoring, collapse = ", "))
...
Variant 1: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest newly_nondiagnosed
```{r Variant 1: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest newly_nondiagnosed, echo=FALSE, message=FALSE}
### Applying to our data
variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- variant1_analyze_best_six_symptoms_by_cluster(simulated_ptsd_data_renamed, score_by = "newly_nondiagnosed")
# Summary
summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- summarize_ptsd_changes(variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg$diagnosis_comparison)
# Readable summary
readable_summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- create_readable_summary(summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg)
datatable(readable_summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg,
          options = list(scrollX = TRUE))
```

Variant 1: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest false_cases
```{r Variant 1: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest false_cases, echo=FALSE, message=FALSE}
### Applying to our data
variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- variant1_analyze_best_six_symptoms_by_cluster(simulated_ptsd_data_renamed, score_by = "false_cases")
# Summary
summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- summarize_ptsd_changes(variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false$diagnosis_comparison)
# Readable summary
readable_summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- create_readable_summary(summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false)
# datatable(readable_summary_variant1_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false,
#           options = list(scrollX = TRUE))
```

##### 5.5.3.2. Variant 2: Find three best 6-symptom-combinations, with at least one symptom from each cluster by checking all possibilities

```{r Variant 2: Find three best 6-symptom-combinations, with at least one symptom from each cluster, echo=FALSE, message=FALSE}
### Function to determine the three best 6-symptom-combinations, with at least one symptom from each cluster by checking all possibilities
  # Depending on the score_by select the best 6-symptom-combinations by minimizing the newly_nondiagnosed or by minimizing the false_cases
  # Input: data set with all patients and 20 columns with non-binarized symptoms
variant2_analyze_best_six_symptoms_by_cluster <- function(data, score_by = "false_cases") {
  # Validate scoring method
  valid_scoring <- c("false_cases", "newly_nondiagnosed")
  if (!score_by %in% valid_scoring) {
    stop("score_by must be one of: ", paste(valid_scoring, collapse = ", "))
...
```
Variant 2: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest newly_nondiagnosed
```{r Variant 2: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest newly_nondiagnosed, echo=FALSE, message=FALSE}
### Applying to our data
variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- variant2_analyze_best_six_symptoms_by_cluster(simulated_ptsd_data_renamed, score_by = "newly_nondiagnosed")
# Summary
summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- summarize_ptsd_changes(variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg$diagnosis_comparison)
# Readable summary
readable_summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg <- create_readable_summary(summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg)
datatable(readable_summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false_neg,
          options = list(scrollX = TRUE))
```
Variant 2: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest false_cases
```{r Variant 2: Summary for three best six-symptom-combinations with at least one from each cluster. Best means fewest false_cases, echo=FALSE, message=FALSE}
### Applying to our data
variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- variant2_analyze_best_six_symptoms_by_cluster(simulated_ptsd_data_renamed, score_by = "false_cases")
# Summary
summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- summarize_ptsd_changes(variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false$diagnosis_comparison)
# Readable summary
readable_summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false <- create_readable_summary(summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false)
datatable(readable_summary_variant2_PTSD_Diagnosis_best_six_symptoms_by_cluster_min_false,
          options = list(scrollX = TRUE))
```

### 5.6. Polythetic diagnostic criteria: the three best 6 symptom combinations for which the diagnosis is fulfilled with at least 4/6

#### 5.6.1. Three best 6-symptom combinations, of which at least 4 must be present to fulfill the diagnosis, regardless of the cluster
...
datatable(readable_summary_PTSD_Diagnosis_best_six_four_required_min_false_neg,
          options = list(scrollX = TRUE))
```
Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, regardless of the cluster. Best means fewest false_cases
```{r Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, regardless of the cluster. Best means fewest false_cases, echo=FALSE, message=FALSE}
### Applying to our data
PTSD_Diagnosis_best_six_four_required_min_false <- analyze_best_six_symptoms_four_required(simulated_ptsd_data_renamed, score_by = "false_cases")
# Summary
summary_PTSD_Diagnosis_best_six_four_required_min_false <- summarize_ptsd_changes(PTSD_Diagnosis_best_six_four_required_min_false$diagnosis_comparison)
# Readable summary
readable_summary_PTSD_Diagnosis_best_six_four_required_min_false <- create_readable_summary(summary_PTSD_Diagnosis_best_six_four_required_min_false)
datatable(readable_summary_PTSD_Diagnosis_best_six_four_required_min_false,
          options = list(scrollX = TRUE))
```

#### 5.6.2. Three best 6-symptom combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster

##### 5.6.2.1. Variant 1: Identification of the best three six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster by analyzing individual importance, selecting top candidates and testing different combinations
```{r Variant 1: Identification of the best three six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster, echo=FALSE, message=FALSE}
### Function to determine the three best 6-symptom-combinations overall, where at least 4 need to be present for diagnosis, one from each cluster by 1. analyzing individual importance of symptoms, 2. selecting most important symptoms from each cluster as candidates, 3. testing different combinations of these candidates to chose best
  # Depending on the score_by select the best 6-symptom-combinations by minimizing the newly_nondiagnosed or by minimizing the false_cases
  # Input: data set with all patients and 20 columns with non-binarized symptoms
variant1_analyze_best_six_symptoms_four_required_clusters<- function(data, score_by = "false_cases") {
  # Validate scoring method
  valid_scoring <- c("false_cases", "newly_nondiagnosed")
  if (!score_by %in% valid_scoring) {
    stop("score_by must be one of: ", paste(valid_scoring, collapse = ", "))
  ...
  # Get top candidates from each cluster
  message("Pre-selecting top candidates from each cluster...")
  top_cluster1 <- get_top_candidates(binarized_data, clusters$cluster1, 3)  # Top 3 from cluster 1
  top_cluster2 <- get_top_candidates(binarized_data, clusters$cluster2, 2)  # All from cluster 2
  top_cluster3 <- get_top_candidates(binarized_data, clusters$cluster3, 3)  # Top 3 from cluster 3
  top_cluster4 <- get_top_candidates(binarized_data, clusters$cluster4, 3)  # Top 3 from cluster 4
  
  # Helper function to check cluster representation
  check_cluster_representation <- function(present_symptoms) {
    sapply(clusters, function(cluster) {
      any(present_symptoms %in% cluster)
    }) %>% all()
  }
  
  # Helper function to get diagnosis with optimized criteria checking
  get_diagnosis <- function(data, symptoms) {
    subset_data <- data[, paste0("symptom_", symptoms)]
    return(apply(subset_data, 1, function(row) {
      present_symptoms <- symptoms[which(row)]
      num_present <- length(present_symptoms)
      if(num_present >= 4) {
        # Only check cluster representation if we have enough symptoms
  ...
  # Generate all valid combinations more efficiently
  message("Generating and testing combinations...")
  total_combinations <- 0
  valid_combinations <- list()
  
  # First, ensure one from each cluster
  for(s1 in top_cluster1) {
    for(s2 in top_cluster2) {
      for(s3 in top_cluster3) {
        for(s4 in top_cluster4) {
          base_combination <- c(s1, s2, s3, s4)
          # Get remaining available symptoms
          available_symptoms <- setdiff(
            c(top_cluster1, top_cluster2, top_cluster3, top_cluster4),
            base_combination
          )
          # Add two more symptoms from available ones
          if(length(available_symptoms) >= 2) {
            additional_pairs <- combn(available_symptoms, 2, simplify = FALSE)
            for(pair in additional_pairs) {
              valid_combinations[[length(valid_combinations) + 1]] <- 
                sort(c(base_combination, pair))
  ...
  message(sprintf("Testing %d valid combinations...", total_combinations))
  
  # Test each combination
  for(i in seq_along(valid_combinations)) {
    if(i %% 100 == 0) {
      message(sprintf("Progress: %d/%d combinations tested", i, total_combinations))
    }
    ...
    if(score > best_combinations$first$score) {
      ...
      best_combinations$first <- list(
        ...
        metrics = metrics
              ...
              !identical(combination, best_combinations$first$combination)) {
      best_combinations$third <- best_combinations$second
      best_combinations$second <- list(
        ...
        metrics = metrics
             ...
             !identical(combination, best_combinations$first$combination) && 
             !identical(combination, best_combinations$second$combination)) {
  ...
  colnames(comparison_df)[2:4] <- sapply(c("first", "second", "third"), function(rank) {
    sprintf("symptoms_%s", paste(best_combinations[[rank]]$combination, collapse = "_"))
  })
...
Variant 1: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest newly_nondiagnosed
```{r Variant 1: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest newly_nondiagnosed, echo=FALSE, message=FALSE}
### Applying to our data
variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- variant1_analyze_best_six_symptoms_four_required_clusters(simulated_ptsd_data_renamed, score_by = "newly_nondiagnosed")
# Summary
summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- summarize_ptsd_changes(variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg$diagnosis_comparison)
# Readable summary
readable_summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- create_readable_summary(summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg)
datatable(readable_summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg,
          options = list(scrollX = TRUE))
```

Variant 1: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest false_cases
```{r Variant 1: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest false_cases, echo=FALSE, message=FALSE}
### Applying to our data
variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- variant1_analyze_best_six_symptoms_four_required_clusters(simulated_ptsd_data_renamed, score_by = "false_cases")
# Summary
summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- summarize_ptsd_changes(variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false$diagnosis_comparison)
# Readable summary
readable_summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- create_readable_summary(summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false)
datatable(readable_summary_variant1_PTSD_Diagnosis_best_six_four_required_clusters_min_false,
          options = list(scrollX = TRUE))
```

##### 5.6.2.2. Variant 2: Identification of the best three six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster by analyzing all possible combinations
```{r Variant 2: Identification of the best three six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster, echo=FALSE, message=FALSE}
### Function to determine the three best 6-symptom-combinations overall, where at least 4 need to be present for diagnosis, one from each cluster by testing all valid (at least one symptom from each cluster) combinations
  # Depending on the score_by select the best 6-symptom-combinations by minimizing the newly_nondiagnosed or by minimizing the false_cases
  # Input: data set with all patients and 20 columns with non-binarized symptoms
variant2_analyze_best_six_symptoms_four_required_clusters <- function(data, score_by = "false_cases") {
  # Validate scoring method
  valid_scoring <- c("false_cases", "newly_nondiagnosed")
  if (!score_by %in% valid_scoring) {
    stop("score_by must be one of: ", paste(valid_scoring, collapse = ", "))
  ...
  for(s1 in clusters$cluster1) {
    message(sprintf("Processing cluster 1: symptom %d/%d", s1, max(clusters$cluster1)))
  ...
  total_combinations <- length(valid_combinations)
  message(sprintf("Testing %d combinations...", total_combinations))
  
  # Test combinations with progress updates every 5%
  report_interval <- max(1, floor(total_combinations / 20))
  
  for(i in seq_along(valid_combinations)) {
    if(i %% report_interval == 0) {
      message(sprintf("Progress: %.1f%%", i/total_combinations*100))
    }
...
```
Variant 2: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest newly_nondiagnosed
```{r Variant 2: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest newly_nondiagnosed, echo=FALSE, message=FALSE}
### Applying to our data
variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- variant2_analyze_best_six_symptoms_four_required_clusters(simulated_ptsd_data_renamed, score_by = "newly_nondiagnosed")
# Summary
summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- summarize_ptsd_changes(variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg$diagnosis_comparison)
# Readable summary
readable_summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg <- create_readable_summary(summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg)
datatable(readable_summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false_neg,
          options = list(scrollX = TRUE))
```

Variant 2: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest false_cases
```{r Variant 2: Summary for three best six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one from each cluster. Best means fewest false_cases, echo=FALSE, message=FALSE}
### Applying to our data
variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- variant2_analyze_best_six_symptoms_four_required_clusters(simulated_ptsd_data_renamed, score_by = "false_cases")
# Summary
summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- summarize_ptsd_changes(variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false$diagnosis_comparison)
# Readable summary
readable_summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false <- create_readable_summary(summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false)
datatable(readable_summary_variant2_PTSD_Diagnosis_best_six_four_required_clusters_min_false,
          options = list(scrollX = TRUE))
```

#### 5.6.3. Summary for any selected combination of 6 symptoms, of which at least 4 symptoms must be present to fulfill the diagnosis

##### 5.6.3.1. Summary for any selected 6-symptom combination, of which at least 4 symptoms must be present, regardless of cluster
...
```
Summary for selected six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, regardless of cluster. selected 6 symptoms = 6 best symptoms overall as in chapter 5.5.1.
...
##### 5.6.3.2. Summary for any selected 6-symptom combination, of which at least 4 symptoms must be present, one from each cluster
...
```
Summary for selected six-symptom-combinations, of which at least 4 must be present to fulfill the diagnosis, one of each cluster. selected 6 symptoms = 6 best symptoms overall as in chapter 5.5.1.
